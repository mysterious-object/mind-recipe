/// Bounded, private tool routing for the on-device Mind Nav assistant.
///
...
class MindNavAgentPlan {
  const MindNavAgentPlan({
    required this.tool,
...
Selected Mind Nav support: $tool
