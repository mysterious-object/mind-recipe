...
Mind Nav removes a duplicate `llama_free_model` call when native context
...
Mind Nav also exposes the package's existing native clear command through the
